...
const Registeration = () => {
    return (
        <div className="head">
            ...
            <p>Та өмнө нь бүртгүүлж байсан уу? 
                <button type="button" className="button1">Нэвтрэх</button> </p>
            <div className="blah"> <hr></hr>Шинээр бүртгүүлэх <hr></hr></div>
                <div className="head3">
                    ...
                    <button className="button" type="submit" onClick="">Бүртгүүлэх</button>
